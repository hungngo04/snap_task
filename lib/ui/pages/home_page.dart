...
class _HomePageState extends State<HomePage> {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (task.repeat == 'Daily') {
                  ...
                  DateTime date= DateFormat("hh:mm a").parse(task.startTime!);
                  var notiMinutes = date.minute;
                  var notiHours = date.hour;
  ...
  /*
                  ...
                  notifyHelper.scheduledNotification(notiHours, notiMinutes, task);
